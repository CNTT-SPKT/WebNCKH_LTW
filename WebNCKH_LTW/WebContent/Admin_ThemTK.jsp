													...
													<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
														<div action="" style="margin:15px 10px 30px 50px;">
															<div class="col-xs-10">
																...
																<input type="text" name="name" class="form-control required name" placeholder="Lâm Xuân Triết"  id="name" required minlength="6" data-placement="right" data-trigger="hover" data-content="Bạn cần phải nhập vào trường này.">
															</div><br>
															<div class="col-xs-10">
																<label for="email">Email<span>:</span></label> 
																<input type="text" name="email" class="form-control required email" placeholder="LVA@gmail.com"  id="email" required data-placement="right" data-trigger="hover" data-content="Bạn cần phải nhập vào trường này">
															</div><br>
															<div class="col-xs-10">
															...
															<div class="col-xs-10">
																<label for="mota">Tài khoản<span>:</span></label>
																<input type="text" name="mota" class="form-control required mota" placeholder="Sinh viên"  id="mota" required minlength="6" data-placement="right" data-trigger="hover" data-content="Bạn cần phải nhập vào trường này.">
															</div>
														</div>
													</div>
													<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
														<div action="" onsubmit="" style="margin:15px 0px 30px 20px;">
															<div class="col-xs-10">
																<label for="password1">Mật khẩu<span>:</span></label> 
																<input type="password" name="password1" class="form-control required password1"   id="password1" required minlength="6" data-placement="right" data-trigger="hover" data-content="Bạn cần phải nhập vào trường này.">
															</div><br>
															<div class="col-xs-10">
																<label for="mssv">Mã số<span>:</span></label> 
																<input type="text" name="mssv" class="form-control required mssv" placeholder="14110208"  id="mssv" required minlength="6" data-placement="right" data-trigger="hover" data-content="Bạn cần phải nhập vào trường này.">
															</div><br>
															<div class="col-xs-10">
																<label for="ngành">Ngành<span>:</span></label>
																<input type="text" name="mota" class="form-control required mota" placeholder="CNTT"  id="ngành" required minlength="6" data-placement="right" data-trigger="hover" data-content="Bạn cần phải nhập vào trường này.">
															</div><br>
