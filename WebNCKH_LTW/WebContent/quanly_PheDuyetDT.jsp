                ...
                <div class="col-md-10">
                    <div class="tab-content">
                       	<div class="tab-pane active" id="PheDuyet">
							<div class="row">
							<div class="gv_PheDuyetDT" style="background:white;height:1650px;margin-right:15px;border-radius:3px">
								<h2 style="margin-top:0px;padding:10px;font-family:sans-serif; text-align: center;">PHÊ DUYỆT ĐỀ TÀI</h2>
								<div class="container" style="width:800px">
											...
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<form action=" " onsubmit="" method="POST" role="form" class="form-horizontal">
														<div class="form-group">
															...
															<label class="col-sm-2 control-label" style="" for="tendetai">Tải file chi tiết:</label>
															<div class="col-sm-10" style="margin-bottom:10px">
																<input class="form-control" id="tendetai" type="file">
															</div>
															<label class="col-sm-2 control-label" style=""  for="tendetai">Cấp mã đề tài: </label>
															<div class="col-sm-10" style="margin-bottom:10px">
																<input placeholder="Cấp mã tại đây" class="form-control" id="capmadt" name="capma" value="" type="text">
															</div>
									...
									<a href=""><button type="button" class="btn btn-lg btn-default btn-warning" style="margin-left:300px">Phê duyệt</button></a>
								<a href=""><button type="button" class="btn btn-lg btn-default btn-danger">Không đồng ý</button></a>
								</div>
							</div>
						</div>
