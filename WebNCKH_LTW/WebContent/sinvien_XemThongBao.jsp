										...
										<div class="svThongBao " style="background:white;height:500px;margin-right:15px;border-radius:3px">
											...
											<div class="sv_table_thongbao" ng-app="sortApp" ng-controller="mainController">
												...
												<table class="table table-striped table-hover">
													...
													<tbody>
														<%
				     										for (TB_TK thongbaotk: cttb.getListTB_TKByMaTK(session.getAttribute("Email").toString())) {
														%>
														<tr >
																<td><input type="checkbox" name=""  value=""></td>
																<td><%=thongbaotk.getTinTB() %></td>
																<td><%=thongbaotk.getTenNguoiGui() %></td>
																<td><%=thongbaotk.getNgayGui() %></td>
